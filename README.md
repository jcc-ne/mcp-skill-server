...
```
1. Claude skill                → SKILL.md + scripts, but no fixed entry — agent decides how to run them
...
Most skills start as something you use locally with Claude. When you want reliability and deployability, add the entry point. Use `skill init` to scaffold it. Use `validate` to check readiness for production.
